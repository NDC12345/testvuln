...
if (array_key_exists ("id", $_GET) &&
	...
	if ($locale == 'en') {
if ($locale == 'en') {
		echo file_get_contents( DVWA_WEB_PAGE_TO_ROOT . "vulnerabilities/{$id}/help/help.php" );
	} else {
		echo file_get_contents( DVWA_WEB_PAGE_TO_ROOT . "vulnerabilities/{$id}/help/help.{$locale}.php" );
	}
	} else {
